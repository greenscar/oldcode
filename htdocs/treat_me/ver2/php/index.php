...
echo("\t\t\t<TR>\n");
echo("\t\t\t\t<TD ALIGN=\"CENTER\" HEIGHT=\"$logo_cell_y\" WIDTH=\"$logo_cell_x\">\n");
echo("<a href=\"../index.php?UID=$UID\">");
echo("<IMG SRC=\"../photos/treat_logo.gif\">");
echo("</a>\n");
echo("</TD>\t\t\t</TR>\n");
...
while($row = mysql_fetch_array($categories)){
	...
	if(!empty($numItems[0])){
		$link_to = strtolower(str_replace(" ", "", $category_name));
		$link_to = "../$link_to.php";
		...
		echo("\t\t\t\t\t<a href='$link_to?UID=$UID' class=menu>$category_name</a>\n");
		echo("\t\t\t\t</TD>\n");
		echo("\t\t\t</TR>\n");
	}
...
*/
echo("\t\t<TD VALIGN=\"TOP\">\n");
echo("\t\t\t<TABLE BORDER=\"$border_size\" WIDTH=\"$description_x\" HEIGHT\"$item_detail_y\"  VALIGN=\"TOP\" ALIGN=\"center\">\n");
