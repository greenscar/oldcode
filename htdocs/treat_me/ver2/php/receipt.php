...
if ($payment_method == "Check") {
	blackFont("Arial","<b>Make check payable to:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br>");
} 
else {
	echo "";
}
...
if ($payment_method == "Check") {
	blackFont("Arial","<b>Send check to:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br>");
} 
else {
	echo "";
}
...
echo  "</th>";
echo  "<th>";
blackFont( "Arial", "Name");
echo  "</th>";
echo  "<th>";
blackFont( "Arial", "Flavor");
echo  "</th>";
echo  "<th>";
blackFont( "Arial", "Size");
echo  "</th>";
echo  "<th>";
...
if ($payment_method == "Check") {
	fontSize(4,"black","Arial","You have elected to pay via ");
	fontSize(4,"white","Arial","Check or Money Order.");
	fontSize(4,"black","Arial","<br>We will ship the products you ordered upon receipt of your payment.<br><BR>");
} 
elseif ($payment_method == "Credit") {
	fontSize(4,"black","Arial","You have elected to pay via ");
	fontSize(4,"white","Arial","$cc_type");
	//fontSize(4,"black","Arial"," credit card.<br>We will ship the products you ordered upon credit approval.<BR><br>");
}
else if ($payment_method == "Other") {
	fontSize(4,"black","Arial","We will contact you to make payment arrangements.<br><BR>");
}
if ($contact_buyer == '1') {
	fontSize(4,"black","Arial","We will contact you before fulfilling this order.<br><BR>");
} 
else {
	echo "";
}
...
//fontSize("-1","Red","Arial","<a href=\"". $Relative . "receipt.php?buyer_id=$buyer_id&order_number=$order_number&payment_method=$payment_method&CT=$cc_type&contact_buyer=$contact_buyer\">$Webreceipt.php?buyer_id=$buyer_id&order_number=$order_number&payment_method=$payment_method&CT=$cc_type&contact_buyer=$contact_buyer</a>");
echo "<center><p><hr width=\"70%\"><p>";
whiteFont("Arial","<a href=\"./view_cart.php\">Shopping Cart</a> | ");
whiteFont("Arial","<a href=\"http://www.treatbeauty.com\">Home</a></center></td></tr></table></html>");
