...
/*********************************************************
 * checkout.php 
 * If the shopping cart is empty, the user gets a message
 * 	sharing this.
 * If there are items in the shopping cart:
 * 	Displays the shopping cart and its contents.
 *      Asks the user if they want to check out.
 *********************************************************/
include("header.inc");
...
if ($num == "0") {
	...
	echo "</form>\n";
	echo "<p>";
	fontSize("+1","white","Arial","<b>How would you like to check out?</b><p>\n");
	//echo "<form action=\"user_info.php\" method=\"post\" target=\"_parent\">
	echo "<form action=\"$WebSecure/user_info_check.php\" method=\"post\" target=\"_parent\">
	<input type=\"hidden\" name=\"UID\" value=\"$UID\">
	<input type=\"hidden\" name=\"OrderTotal\" value=\"$total\">
	<input type=\"submit\" value=\"Pay via Check or Other\"></form>";
	echo "<form action=\"$WebSecure/user_info_credit.php\" method=\"post\" target=\"_parent\">
	<input type=\"hidden\" name=\"UID\" value=\"$UID\">
	<input type=\"hidden\" name=\"OrderTotal\" value=\"$total\">
	<input type=\"submit\" value=\"Pay via Credit Card\"></form>
