   ...
   <div class="body">
      <table style="width: 750px;height: 506px;">
        ...
        <tr>
         ...
         <td rowspan="4" colspan="2"><a href="contact.php" onMouseOut="nbGroup('out');" onMouseOver="nbGroup('over','contact','images/contact_f2.png','images/contact_f3.png',1);" onClick="nbGroup('down','navbar1','contact','images/contact_f3.png',1);"><img name="contact" src="images/contact_f2.png" width="79" height="32" border="0" alt="contact us"></a></td>
            ...
            -->
               <div class="contact_us">
                  ...
                  <form name="form1" method="post" action="<?php echo($_POST["PHP_SELF"]); ?>" onsubmit="return validateForm(this);">
                     <table style="height: 300px; width: 600px; border: 0px solid red;">
                        <tr valign="top"> 
                           ...
                           <td width="35%" rowspan="9" style="border-left: 1px solid #333333;"> 
                              <table style="height: 300px; width: 200px; border: 0px solid red;">
                                 <tr> 
                                    <td align="right">
                                       <strong>Photography by Design</strong><br>
                                       626 W 20th St.<br>
                                       Houston, TX 77008
                                    </td>
                                 </tr>
                                 ...
                                 <tr> 
                                    <td align="right">713.455.8833</td>
                                 </tr>
                                 <tr> 
                                    <td align="right">&nbsp;</td>
                                 </tr>
                        ...
                        <tr valign="top"> 
                           ...
                           <td> 
                              <input name="day_phone" type="text" id="day_phone" class="textfield">
                           </td>
                        </tr>
                        <tr valign="top"> 
                           <td class="bold">Evening Phone:</td>
                           <td> 
                              <input name="evening_phone" type="text" id="evening_phone" class="textfield">
                           </td>
                        </tr>
                        <tr valign="top"> 
                        ...
                        <tr valign="top"> 
                           ...
                           <td> 
                              <input name="event_date" type="text" id="event_date" class="textfield">
                           </td>
                        </tr>
                        <tr valign="top"> 
                        <tr valign="top"> 
