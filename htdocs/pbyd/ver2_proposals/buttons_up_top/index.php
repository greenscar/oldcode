...
<body style="text-align: center;background-image: url(brushed_metal.jpg); color: #FFFFFF;padding-top: 20px;" onload="init();">
<div class="body">
   <div class="button_bar_top">
      <div class="main_button" style="left: -1px; top: -2px;z-index:10;" onMouseOver="this.className='main_button_over';" onMouseOut="this.className='main_button';">
         <span class="main_button">HOME</span>
      </div>
      <div class="main_button" style="left: <?=$button_width + 50?>;px; top: -2px;" onMouseOver="this.className='main_button_over';" onMouseOut="this.className='main_button';">
         <span class="main_button">
            EVENTS
         </span>
      </div>
      <div class="main_button" style="right: <?=$button_width + 50?>;px; top: -2px;z-index:10;" onclick="self.location='about_us.php'" onMouseOver="this.className='main_button_over';/*showLayer('subMenuAbout');*/" onMouseOut="this.className='main_button';">
         <span class="main_button" >
            ABOUT
         </span>
      </div>
      <div class="main_button" style="right: -1px; top: -2px;z-index:10;" onMouseOver="this.className='main_button_over';showLayer('subMenuGallery');" onMouseOut="this.className='main_button';">
         <span class="main_button">GALLERY</span>
      </div>
   </div>
   <!--
   <div class="button_bar_bottom">
      <div class="main_button" style="left: -1px; top: -1px;" onMouseOver="this.className='main_button_over';" onMouseOut="this.className='main_button';">
         <span class="main_button">
            EVENTS
         </span>
      </div>
   ...
   -->
   <div id="fxn_hide_layer" class="hideMenu" style="position: absolute; left: -10px; top:-10; width: <?=($body_width + 20)?>; height: <?=($body_height + 20)?>; z-index:1;border: 0px solid red;"  onMouseOver="hideLayers();">
