...
$title = "Store Tables";
include("header.inc");
$tbl_dbmgr = new DB_Mgr("rics");
  
$selectTables = "select name from sysobjects where type='U' and (name like 'CM_%' or name like 'RICS_%' or name like 'SH_%')";
$tbl_dbmgr->query($selectTables);


echo("<table border=4 align=\"center\">");
echo("<tr valign=\"middle\"><td><h1> <font color=#FFFFFF>RICS Tables</font></h1></td></tr>");
echo("</table>");
