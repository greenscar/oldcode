...
$guestbookurl = "http://tamsplace.com/guestbk.htm";
$guestbookreal = "/usr/www/htdocs/tamsplace/guestbk.htm";
$guestlog = "/usr/www/htdocs/tamsplace/guestlog.html";
$cgiurl = "http://tamsplace.com/cgi-bin/guestbook.cgi";
...
sub no_comments {
   ...
   print "<body bgcolor=ffffff><h1><i>Your Comments appear to be blank</i></h1>\n";
...
sub no_name {
   ...
   print "<body bgcolor=ffffff><h1><i>Your Name appears to be blank</i></h1>\n";
...
sub no_redirection {
   ...
   print "<body bgcolor=ffffff><h1><i>Thank You For Signing The Guestbook</i></h1>\n";
