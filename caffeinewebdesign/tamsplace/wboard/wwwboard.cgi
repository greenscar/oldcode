...
$basedir = "/www/htdocs/tamsplace/wboard";
$baseurl = "http://tamsplace.com/wboard";
$cgi_url = "http://tamsplace.com/wboard/wwwboard.cgi";
$mesgdir = "messages";
$datafile = "data.txt";
$mesgfile = "bulletin.htm";
$faqfile = "faq.html";
$ext = "html";
...
sub return_html {
   ...
   print "<body bgcolor=#ffffff><center><h1>Message Added: $subject</h1></center>\n";
...
sub error {
   ...
   if ($error eq 'no_name') {
      ...
      print "<body bgcolor=#ffffff><center><h1>ERROR: No Name</h1></center>\n";
      ...
      print "<body bgcolor=#ffffff><center><h1>ERROR: No Subject</h1></center>\n";
      ...
      print "<body bgcolor=#ffffff><center><h1>ERROR: No Message</h1></center>\n";
