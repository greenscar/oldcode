...
What is JUPLOAD?
 ...
 It uses RFC1867 and the HTTP methods POST or PUT.
...
Features
 ...
 Image preview
 Status display
 File upload resuming (only with PUT method)
 Remote controllable (JavaScript)
...
Requirements
 Browser supporting Java Plug-In
 Java 2 Standard Edition (v1.3 or higher)
...
Credits
 ...
 thanks go to the translation work of the following people:
	...
	(please contact me, i lost your mail) [hu_HU]
 ...
 * Date: $Date: 2004/05/19 11:51:03 $
 * Id: $Id: readme.txt,v 1.19.2.1 2004/05/19 11:51:03 mhaller Exp $
