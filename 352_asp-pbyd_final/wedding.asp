...
<html>
<head>
<title>Photography by Design Weddings</title>
...
<body bgcolor="#666666" onLoad="MM_preloadImages('buttons/homebuttonOver.jpg','buttons/bridebuttonOver.jpg','buttons/recentweddingbuttonOver.jpg','buttons/linksbuttonOver.jpg','buttons/portraitbuttonOver.jpg')">
...
<%
	...
	SqlJunk = SqlJunk & " WHERE photoType LIKE '%" & "wedding" & "%'"
...
<table width="75%" border="0" vspace="0" hspace="30" align = "center">
  <tr> 
    ...
    <td><a href="bride.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','buttons/bridebuttonOver.jpg',1)"><img name="Image3" border="0" src="buttons/bridebuttonUn.jpg" width="144" height="72"></a></td>
